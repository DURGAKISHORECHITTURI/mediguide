                ...
                <NAV class="container1">
                    ...
                    <div class="innercontainer2">
                        <form method="post" action="">
                            ...
                            <input type="text" required name="availability"></div>
                            <div><label>STOCK COUNT :</label>
                            <input type="text" required name="count"></div>
                            <span>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `" . $table_name . "` SET quantity = quantity - $quantity, availability = '$availability' WHERE medicinename = '$medicinename'";

    if ($conn->query($sql) === TRUE) {
        echo "<br>";
        echo "<br>";
        echo "<br>";
        echo "<label>DATA UPDATED SUCCESSFULLY</label>";
